...
###############################################################################
#Example for adding madeup features
###############################################################################
...
#Plot the results
plt.figure(num='Curve with extra feature')
...
plt.plot(data[0:300, 1:2], data[0:300, 0:1], 'rx', data[300:, 1:2], prediction, 'o')
plt.xlabel('Horsepower (hp)')
plt.ylabel('Miles per Galon')

#Plot the results
plt.figure(num='Results for exercise 3_')
plt.plot(data[0:300, 2:3], data[0:300, 0:1], 'rx', data[300:, 2:3], prediction, 'o')
